...
describe('Metadatas Class', () => {
    describe('Constructor', () => {
        it('should initialize with default values when no arguments are provided', () => {
            const metadata = new Metadatas_1.Metadatas();
        ...
        it('should initialize with a name when provided', () => {
            const metadata = new Metadatas_1.Metadatas('TestName');
    ...
    describe('setFilters', () => {
        ...
        it('should merge filters correctly', () => {
            ...
            expect(metadata.filters).toEqual(Object.assign(Object.assign({}, initialFilters), newFilters));
        });
