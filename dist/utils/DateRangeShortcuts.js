...
class DateRangeShortcuts {
     ...
     */
    isInRange(startDate, currentDate, endDate) {
        if (!currentDate)
            return false;
     ...
     */
    addLogicComparatorOnGridDefinitionColumn(columnDef) {
...
exports.DateRangeShortcuts = DateRangeShortcuts;
// Export a singleton instance for convenience
exports.dateRangeShortcuts = new DateRangeShortcuts();
//# sourceMappingURL=DateRangeShortcuts.js.map