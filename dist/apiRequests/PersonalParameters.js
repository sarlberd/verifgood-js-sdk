...
exports.PersonalParameters = void 0;
 ...
 */
class PersonalParameters extends ApiRequest_1.ApiRequest {
    get endpoint() {
     ...
     */
    getDefaultLandingPage(role = null) {
    ...
    isDisplayable(key) {
        ...
        try {
            const stored = localStorage.getItem("personalParameters_isdisplayable");
            if (!stored)
                return true; // Default to displayable if no config exists
...
exports.PersonalParameters = PersonalParameters;
//# sourceMappingURL=PersonalParameters.js.map