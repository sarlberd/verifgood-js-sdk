 ...
 */
class Inventaire extends ApiRequest_1.ApiRequest {
    constructor() {
        super(...arguments);
        this.endpoint = '/api/inventaires';
        this.endpointSingleton = '/api/inventaire';
    }
    /**
    ...
    async getAll(metadatas) {
        ...
        return this.get(this.endpoint, metadatas || new Metadatas_1.Metadatas(), {});
    }
    /**
    ...
    async getById(id) {
        ...
        return this.get(`/api/${userId}/inventaire/${id}`, new Metadatas_1.Metadatas(), {});
    }
    /**
     ...
     */
    async fetchOperationsByInventaireId(id) {
        const userId = null; // this.$app.appID equivalent
        return this.get(`/api/${userId}/inventaire/${id}/operations`, new Metadatas_1.Metadatas(), {});
    }
    /**
     ...
     * @returns Promise with operations data
     */
    async fetchOperationsByInventaireIdOnLieu(inventaire_id, lieu_id) {
        const userId = null; // this.$app.appID equivalent
        return this.get(`/api/${userId}/inventaire/${inventaire_id}/operations/lieu/${lieu_id}`, new Metadatas_1.Metadatas(), {});
    }
    /**
     * @deprecated
     ...
     */
    async finalizeInventaireOnLieu(inventaire_id, lieu_id) {
        //@TODO: need review - deprecated method, consider removal
        const userId = null; // this.$app.appID equivalent
     ...
     */
    async createOperation(operation, inventaire_id, lieu_id) {
