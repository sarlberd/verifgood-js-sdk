...
exports.MouvementsEquipements = void 0;
 ...
 */
class MouvementsEquipements extends ApiRequest_1.ApiRequest {
    constructor() {
        super(...arguments);
        this.endpoint = '/api/mouvements';
        this.endpointSingleton = '/api/mouvements';
    }
    /**
     ...
     */
    async updateMovement(mouvementEquipement) {
        if (!(mouvementEquipement === null || mouvementEquipement === void 0 ? void 0 : mouvementEquipement.id)) {
     ...
     */
    async createMovement(mouvementEquipement, type) {
        if (!type) {
     ...
     */
    async deleteMovement(mouvementEquipement) {
        if (!(mouvementEquipement === null || mouvementEquipement === void 0 ? void 0 : mouvementEquipement.id)) {
     ...
     */
    async getMouvementsSignataires(metadatas, type = 'receveurs') {
     ...
     */
    async exportMovements(metadatas, filename = null, fileExtension = 'xlsx') {
        ...
        const exportMetadatas = new Metadatas_1.Metadatas();
...
exports.MouvementsEquipements = MouvementsEquipements;
//# sourceMappingURL=MouvementsEquipements.js.map