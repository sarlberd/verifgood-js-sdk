<!-- START CHUNK: Introduction -->
<!-- filepath: c:\xampp\htdocs\verifgood\VerifgoodSDK\memory-bank\sdkDocumentation.md -->
...
<!-- END CHUNK: Introduction -->

<!-- START CHUNK: Key Features -->
### Key Features
...
<!-- END CHUNK: Key Features -->

<!-- START CHUNK: Installation - NPM -->
## Installation
...
```
<!-- END CHUNK: Installation - NPM -->

<!-- START CHUNK: Installation - Manual -->
### Manual Installation
...
npm run build
```
<!-- END CHUNK: Installation - Manual -->

<!-- START CHUNK: Getting Started - Basic Setup -->
## Getting Started
...
```
<!-- END CHUNK: Getting Started - Basic Setup -->

<!-- START CHUNK: Getting Started - Making Your First API Request -->
...
```
<!-- END CHUNK: Getting Started - Making Your First API Request -->

<!-- START CHUNK: Core Concepts - SDK Configuration -->
## Core Concepts
...
```
<!-- END CHUNK: Core Concepts - SDK Configuration -->

<!-- START CHUNK: Core Concepts - Authentication -->
### Authentication
...
```
<!-- END CHUNK: Core Concepts - Authentication -->

<!-- START CHUNK: Core Concepts - Services -->
### Services
...
<!-- END CHUNK: Core Concepts - Services -->

<!-- START CHUNK: API Services - Categories -->
## API Services
...
vgsdk.categories.remove(123)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - Categories -->

<!-- START CHUNK: API Services - Checkpoints -->
### Checkpoints Service
...
vgsdk.checkpoints.remove(123)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - Checkpoints -->

<!-- START CHUNK: API Services - Equipements -->
### Equipements Service
...
vgsdk.equipements.remove(123)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - Equipements -->

<!-- START CHUNK: API Services - Invitations -->
### Invitations Service
...
vgsdk.invitations.completeRegistration(registrationData)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - Invitations -->

<!-- START CHUNK: API Services - Lieux -->
### Lieux Service
...
vgsdk.lieux.remove(123)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - Lieux -->

<!-- START CHUNK: API Services - SharedLinks -->
### SharedLinks Service
...
vgsdk.sharedLinks.remove(123)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - SharedLinks -->

<!-- START CHUNK: API Services - Taches -->
### Taches Service
...
vgsdk.taches.remove(123)
  .then(result => console.log(result));
```
<!-- END CHUNK: API Services - Taches -->

<!-- START CHUNK: Working with Metadata - Creating Metadata -->
...
const metadatas = new Metadatas();
```
<!-- END CHUNK: Working with Metadata - Creating Metadata -->

<!-- START CHUNK: Working with Metadata - Setting Filters -->
### Setting Filters
...
```
<!-- END CHUNK: Working with Metadata - Setting Filters -->

<!-- START CHUNK: Working with Metadata - Setting Limits -->
### Setting Limits
...
```
<!-- END CHUNK: Working with Metadata - Setting Limits -->

<!-- START CHUNK: Working with Metadata - Setting Columns -->
### Setting Columns
...
```
<!-- END CHUNK: Working with Metadata - Setting Columns -->

<!-- START CHUNK: Working with Metadata - Checking Filters -->
### Checking Filters
...
```
<!-- END CHUNK: Working with Metadata - Checking Filters -->

<!-- START CHUNK: Working with Metadata - Clearing Filters -->
### Clearing Filters
...
```
<!-- END CHUNK: Working with Metadata - Clearing Filters -->

<!-- START CHUNK: Working with Metadata - Getting Formatted Metadata -->
...
```
<!-- END CHUNK: Working with Metadata - Getting Formatted Metadata -->

<!-- START CHUNK: Error Handling -->
## Error Handling
...
```
<!-- END CHUNK: Error Handling -->

<!-- START CHUNK: Advanced Usage - Async/Await -->
## Advanced Usage
...
fetchCategories();
```
<!-- END CHUNK: Advanced Usage - Async/Await -->

<!-- START CHUNK: Advanced Usage - Chaining Requests -->
### Chaining Requests
...
```
<!-- END CHUNK: Advanced Usage - Chaining Requests -->

<!-- START CHUNK: Examples - Basic Category Retrieval -->
## Examples
...
```
<!-- END CHUNK: Examples - Basic Category Retrieval -->

<!-- START CHUNK: Examples - Filtered Query with Pagination -->
...
```
<!-- END CHUNK: Examples - Filtered Query with Pagination -->

<!-- START CHUNK: Examples - Complete Invitation Flow -->
...
```
<!-- END CHUNK: Examples - Complete Invitation Flow -->

<!-- START CHUNK: Troubleshooting - Common Issues - Authentication Errors -->
## Troubleshooting
...
vgsdk.auth.setApiKey("new-api-key");
```
<!-- END CHUNK: Troubleshooting - Common Issues - Authentication Errors -->

<!-- START CHUNK: Troubleshooting - Common Issues - Network Errors -->
#### Network Errors
...
```
<!-- END CHUNK: Troubleshooting - Common Issues - Network Errors -->

<!-- START CHUNK: Troubleshooting - Common Issues - Incorrect Data Format -->
...
```
<!-- END CHUNK: Troubleshooting - Common Issues - Incorrect Data Format -->

<!-- START CHUNK: Troubleshooting - Getting Help -->
### Getting Help
...
<!-- END CHUNK: Troubleshooting - Getting Help -->
