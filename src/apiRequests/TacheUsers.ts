 ...
 */
export class TacheUsers extends ApiRequest {
  endpoint: string = '/api/tache';
   ...
   */
  public createTacheUsers(tacheUsers: any[], tacheId: number, userId: number | null = null): Promise<any> {
   ...
   * @returns Promise<any>
   */
  private postWithQuery(endpoint: string, data: any, query: any = {}): Promise<any> {
